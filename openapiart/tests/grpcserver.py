...
def web_server(pb2, pb2_grpc):
        ...
        def SetConfig(self, request, context):
            ...
            if (test is not None and (test < 10 or test > 90)):
                res_obj = json_format.Parse(
                    response_400, pb2.SetConfigResponse())
            else:
                res_obj = json_format.Parse(
                    response_200, pb2.SetConfigResponse())
    ...
    def local_web_server():
        ...
        pb2_grpc.add_OpenapiServicer_to_server(
            OpenapiServicer(), server)
