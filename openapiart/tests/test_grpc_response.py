...
def test_invalid_transport():
    ...
    assert execinfo.value.args[0] == """NetConf is not within valid transport types ['http', 'grpc']"""
...
def test_transport_with_ext():
    ...
    assert execinfo.value.args[0] == """ext and transport are not mutually exclusive. Please configure one of them."""
