...
def test_int64(default_config):
    ...
    # negative test case
    error_msg = "Invalid -12319 format, expected int64 at <class 'pyapi.pyapi.PrefixConfig'>"
    ...
    error_msg = "property integer64_list shall be of type <class 'list'> at <class 'pyapi.pyapi.PrefixConfig'> \n [-2000] are not valid"
    default_config.full_duplex_100_mb = 100
    default_config.integer64_list = [-2000]
    with pytest.raises(Exception) as execinfo:
        default_config.serialize("dict")
...
def test_int32(default_config):
    ...
    # negative test case
    error_msg = "Invalid 2147483648 format, expected int32 at <class 'pyapi.pyapi.PrefixConfig'>"
    ...
    error_msg = "property int32_list_param shall be of type <class 'list'> at <class 'pyapi.pyapi.PrefixConfig'> \n [-2147483649] are not valid"
    default_config.int32_param = 100
...
def test_uint32(default_config):
    ...
    # negative test case
    error_msg = "Invalid -1 format, expected uint32 at <class 'pyapi.pyapi.PrefixConfig'>"
    ...
    error_msg = "property uint32_list_param shall be of type <class 'list'> at <class 'pyapi.pyapi.PrefixConfig'> \n [4294967300] are not valid"
...
def test_uint64(default_config):
    ...
    # negative test case
    error_msg = "Invalid -1 format, expected uint64 at <class 'pyapi.pyapi.PrefixConfig'>"
