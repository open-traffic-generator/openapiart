...
func TestConfigGenerated(t *testing.T) {
	...
	config.SetK(v9)
	v12 := config.L()
	v12.SetString("abc").SetInteger(61).SetFloat(100.11).SetDouble(1.7976931348623157e+308).SetMac("00:00:00:00:00:0a").SetIpv4("1.1.1.1").SetIpv6("2000::1").SetHex("0x12")
	v12.HasString()
	v12.HasInteger()
	v12.HasFloat()
	v12.HasDouble()
	...
	v35 := config.MObject()
	v35.SetString("abc").SetInteger(24).SetFloat(100.11).SetDouble(1.7976931348623157e+308).SetMac("00:00:00:00:00:0a").SetIpv4("1.1.1.1").SetIpv6("2000::1").SetHex("0x12")
