...
func TestConfigGenerated(t *testing.T) {
	...
	config.SetK(v9)
	v12 := config.L()
	v12.SetString("abc").SetInteger(31).SetFloat(100.11).SetDouble(1.7976931348623157e+308).SetMac("00:00:00:00:00:0a").SetIpv4("1.1.1.1").SetIpv6("2000::1").SetHex("0x12")
	v12.HasString()
	v12.HasInteger()
	v12.HasFloat()
	v12.HasDouble()
	...
	v30 := v29.Integer()
	v30.SetValue(245).SetValues([]int32{181})
	v31 := v30.Increment()
	v31.SetStart(235).SetStep(155).SetCount(1)
	v31.HasStart()
	v31.HasStep()
	v31.HasCount()
	v31.Step()
	...
	v32 := v30.Decrement()
	v32.SetStart(144).SetStep(1).SetCount(1)
	v32.HasStart()
	v32.HasStep()
	v32.HasCount()
	v32.Step()
	...
	v34 := v33.Checksum()
	v34.SetGenerated("good").SetCustom(76)
	v34.HasGenerated()
	v34.HasCustom()
	v34.Choice()
	v34.Generated()
	...
	v35 := config.MObject()
	v35.SetString("abc").SetInteger(70).SetFloat(100.11).SetDouble(1.7976931348623157e+308).SetMac("00:00:00:00:00:0a").SetIpv4("1.1.1.1").SetIpv6("2000::1").SetHex("0x12")
	v35.ToJson()
	v35.ToYaml()
	v35.ToPbText()
	...
	v36.SetGenerated("good").SetCustom(26248)
	v36.HasGenerated()
	v36.HasCustom()
	v36.Choice()
	v36.Generated()
