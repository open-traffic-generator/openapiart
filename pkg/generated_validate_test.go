...
func TestConfigGeneratedValidate(t *testing.T) {
	...
	_, err := v1.Marshaller().ToYaml()
	assert.NotNil(t, err)
	v2 := config.OptionalObject()
	_, err = v2.Marshaller().ToJson()
	assert.NotNil(t, err)
	v3 := config.E()
	_, err = v3.Marshaller().ToYaml()
	assert.NotNil(t, err)
	v4 := config.F()
	_, err = v4.Marshaller().ToYaml()
	assert.Nil(t, err)
	v5 := config.G().Add()
	_, err = v5.Marshaller().ToYaml()
	assert.Nil(t, err)
	v6 := config.J().Add()
	v7 := v6.JA()
	_, err = v7.Marshaller().ToYaml()
	assert.NotNil(t, err)
	v8 := v6.JB()
	_, err = v8.Marshaller().ToYaml()
	assert.Nil(t, err)
	_, err = v6.Marshaller().ToYaml()
	assert.Nil(t, err)
	v9 := config.K()
	v10 := v9.EObject()
	_, err = v10.Marshaller().ToYaml()
	assert.NotNil(t, err)
	v11 := v9.FObject()
	_, err = v11.Marshaller().ToYaml()
	assert.Nil(t, err)
	_, err = v9.Marshaller().ToYaml()
	assert.NotNil(t, err)
	v12 := config.L()
	v12.SetInteger(9).SetMac("00:00:00:00:00:0a::0b").SetIpv4("1.1.1.1.1").SetIpv6("2000::1::1").SetHex("0x12JKL")
	_, err = v12.Marshaller().ToProto()
	assert.NotNil(t, err)
	v13 := config.Level()
	v14 := v13.L1P1()
	v15 := v14.L2P1()
	_, err = v15.Marshaller().ToYaml()
	assert.Nil(t, err)
	_, err = v13.Marshaller().ToYaml()
	assert.Nil(t, err)
	_, err = v14.Marshaller().ToYaml()
	assert.Nil(t, err)
	v16 := config.Mandatory()
	_, err = v16.Marshaller().ToYaml()
	assert.NotNil(t, err)
	...
	_, err = v19.Marshaller().ToProto()
	assert.NotNil(t, err)
	v20 := v18.Decrement()
	v20.SetStart("1.1.1.1.1").SetStep("1.1.1.1.1")
	_, err = v20.Marshaller().ToProto()
	assert.NotNil(t, err)
	_, err = v18.Marshaller().ToProto()
	assert.NotNil(t, err)
	...
	_, err = v23.Marshaller().ToProto()
	assert.NotNil(t, err)
	v24 := v22.Decrement()
	v24.SetStart("2000::1::1").SetStep("2000::1::1")
	_, err = v24.Marshaller().ToProto()
	assert.NotNil(t, err)
	_, err = v22.Marshaller().ToProto()
	assert.NotNil(t, err)
	...
	_, err = v27.Marshaller().ToProto()
	assert.NotNil(t, err)
	v28 := v26.Decrement()
	v28.SetStart("00:00:00:00:00:0a::0b").SetStep("00:00:00:00:00:0a::0b")
	_, err = v28.Marshaller().ToProto()
	assert.NotNil(t, err)
	_, err = v26.Marshaller().ToProto()
	assert.NotNil(t, err)
	_, err = v25.Marshaller().ToYaml()
	assert.NotNil(t, err)
