...
func (ctrl *apiTestController) responseGetRootResponseError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
...
func (ctrl *apiTestController) responseDummyResponseTestError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
...
func (ctrl *apiTestController) PostRootResponse(w http.ResponseWriter, r *http.Request) {
	var item openapiart.ApiTestInputBody
	if r.Body != nil {
...
func (ctrl *apiTestController) responsePostRootResponseError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
