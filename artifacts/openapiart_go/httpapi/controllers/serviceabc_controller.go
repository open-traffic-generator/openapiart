...
func (ctrl *serviceAbcController) responseGetAllItemsError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
...
func (ctrl *serviceAbcController) responseGetSingleItemError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
...
func (ctrl *serviceAbcController) responseGetSingleItemLevel2Error(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
