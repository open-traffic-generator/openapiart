...
func (ctrl *metricsController) GetMetrics(w http.ResponseWriter, r *http.Request) {
	var item openapiart.MetricsRequest
	if r.Body != nil {
		body, readError := io.ReadAll(r.Body)
		if body != nil {
			item = openapiart.NewMetricsRequest()
...
func (ctrl *metricsController) responseGetMetricsError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
...
func (ctrl *metricsController) responseGetWarningsError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
...
func (ctrl *metricsController) responseClearWarningsError(w http.ResponseWriter, errorKind openapiart.ErrorKindEnum, rsp_err error) {
	var result openapiart.Error
	var statusCode int32
	if errorKind == "validation" {
		statusCode = 400
